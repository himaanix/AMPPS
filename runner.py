...
parser.add_argument("--engine_centric", help = "Use this argument to build in an engine centric manner", default = False, action = 'store_true')
...
if doCollect:
    build.Collect(doCollect, args.annotation, settings, args.ignore_errors)
if doGraph:
